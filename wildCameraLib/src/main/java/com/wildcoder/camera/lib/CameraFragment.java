...
public class CameraFragment extends Fragment implements
	...
	public void startCapture() {
		try {
			...
			Log.e("Activity Defination Missing",
					"Write the below code in manifest");
			Log.e("manifest",
					" <activity android:name=\"com.wildcoder.camera.lib.KitkatCameraBinderActivity\" android:theme=\"@android:style/Theme.Translucent.NoTitleBar\" > />");
		}
	}
