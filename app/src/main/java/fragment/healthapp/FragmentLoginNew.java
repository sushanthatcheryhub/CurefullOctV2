 ...
 */
public class FragmentLoginNew extends Fragment implements
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_create_new:
                ...
                fragmentSignUp.setSharedElementEnterTransition(changeTransform);
                fragmentSignUp.setEnterTransition(explodeTransform);
                CureFull.getInstanse().getFlowInstanse()
                        .addWithBottomTopAnimation(fragmentSignUp, null, true);
                break;
