 ...
 */
public class FragmentReminderDoctorVisit extends Fragment implements View.OnClickListener {
    ...
    private void getReminderMedicine() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, MyConstants.WebUrls.GET_LIST_DOCTOR_VISIT_REM + "cfuuhId=" + AppPreference.getInstance().getcf_uuhid() + "&date=" + Utils.getTodayDate() + "&status=" + status + "&reminderType=" + reminder + "&doctorName=" + doctorName,
