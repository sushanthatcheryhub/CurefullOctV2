 ...
 */
public class StepsCountsItems implements MyConstants.JsonUtils {
    ...
    public StepsCountsItems() {
    }


    public StepsCountsItems(Cursor cur) {
        if (cur == null)
            return;
        try {
            ...
            setDateTime(cur.getString(cur.getColumnIndex("dateTime")));
