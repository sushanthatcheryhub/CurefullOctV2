 ...
 */
public class Reminder_Visit_Docotr_child_ListAdpter extends RecyclerView.Adapter<Reminder_Visit_Docotr_child_ListAdpter.ItemViewHolder> {


    Context applicationContext;
    List<DoctorVisitReminderDoctorName> healthNoteItemses;

    public Reminder_Visit_Docotr_child_ListAdpter(Context applicationContexts,
                                                  List<DoctorVisitReminderDoctorName> healthNoteItemses) {
