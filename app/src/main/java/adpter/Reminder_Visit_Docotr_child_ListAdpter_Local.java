 ...
 */
public class Reminder_Visit_Docotr_child_ListAdpter_Local extends RecyclerView.Adapter<Reminder_Visit_Docotr_child_ListAdpter_Local.ItemViewHolder> {


    Context applicationContext;
    List<Doctor_Visit_Reminder_DoctorListView> healthNoteItemses;

    public Reminder_Visit_Docotr_child_ListAdpter_Local(Context applicationContexts,
                                                        List<Doctor_Visit_Reminder_DoctorListView> healthNoteItemses) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adpter_lab_test_doctor_reminder_list_local
                , null);
...
//        RecyclerView recyclerView = holder.recyclerView_doctor;
        ...
        txt_doctor_self.setText("Appointment with doctor");
...
/*
        ...
        Reminder_doctor_Lab_ListAdpter adapter = new Reminder_doctor_Lab_ListAdpter(applicationContext, healthNoteItemses.get(position).getReminder_doctorListViews());
