...
import fragment.healthapp.Fragment_Cure_Note;
...
public class Cure_Note_ListAdpter extends BaseAdapter implements
        StickyListHeadersAdapter, IOnOtpDoneDelete {
    Context applicationContext;
    List<HealthNoteItems> healthNoteItemses;
    private RequestQueue requestQueue;
    Fragment_Cure_Note fragmentHealthNotes;

    public Cure_Note_ListAdpter(Context applicationContexts,
                                List<HealthNoteItems> patientList, Fragment_Cure_Note fragmentHealthNote) {
